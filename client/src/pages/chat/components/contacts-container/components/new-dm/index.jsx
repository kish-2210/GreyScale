...
<div>
  <Tooltip>
    <TooltipTrigger>
      <IoSearchOutline 
        className="text-xl text-neutral-400 font-light text-opacity-90 text-start hover:text-neutral-100 cursor-pointer transition-all duration-300"
  ...
  <div className="text-xs sm:text-sm md:text-base">
    {contact.email ? contact.email : ""}
      ...
      {searchedContacts.length <= 0 && (
        <div className="text-center text-neutral-400 py-4">Loading...</div>
      )}
    </DialogContent>
  </Dialog>
</div>
